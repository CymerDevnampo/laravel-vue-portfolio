    ...
    <section class="work section" id="work">
        ...
        <div class="work__container container grid">
            <div class="work__card mix web">
                <img src="/cymer/assets/img/work1.jpg" alt="" class="work__img" />
            ...
            <div class="work__card mix movil">
                <img src="/cymer/assets/img/work2.jpg" alt="" class="work__img" />
            ...
            <div class="work__card mix design">
                <img src="/cymer/assets/img/work3.jpg" alt="" class="work__img" />
            ...
            <div class="work__card mix web">
                <img src="/cymer/assets/img/work4.jpg" alt="" class="work__img" />
            ...
            <div class="work__card mix movil">
                <img src="/cymer/assets/img/work5.jpg" alt="" class="work__img" />
